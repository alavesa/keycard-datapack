...
summon minecraft:interaction ~ ~1 ~ {Tags:["kc.reader","kc.req5"],width:0.7f,height:0.7f,response:1b}
tellraw @s {"text":"[Keycards] Placed a Level 5 reader. Step away; right-click it with a keycard.","color":"aqua"}
