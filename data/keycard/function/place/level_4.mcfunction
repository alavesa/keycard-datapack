...
summon minecraft:interaction ~ ~1 ~ {Tags:["kc.reader","kc.req4"],width:0.7f,height:0.7f,response:1b}
tellraw @s {"text":"[Keycards] Placed a Level 4 reader. Step away; right-click it with a keycard.","color":"aqua"}
